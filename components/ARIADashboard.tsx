...
interface ARIADashboardProps {
  ...
  studySchedule?: any; // From createStudySchedule tool
  onStartQuiz: () => void;
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 380px", gap: 24 }}>
                ...
                {recentQuizzes.map((quiz, index) => (
                  <div 
                    ...
                    style={{
                      ...
                      border: "1px solid rgba(201,135,79,0.1)",
                      borderRadius: 12,
                      padding: "14px 18px",
                      display: "flex",
                  ...
                  >
                    <div>
                      ...
                      <div style={{ fontSize: 12, color: "rgba(237,224,212,0.5)" }}>
                        {Object.keys(quiz.domain_scores).length} domains tested
                      </div>
                    </div>
                    <div style={{ 
                      fontSize: 20, 
                      fontWeight: 600,
                      color: quiz.score >= 70 ? "#4ade80" : "#fbbf24"
                    }}>
                      {quiz.score}%
                    </div>
                  </div>
        ...
        {/* Right Column - Quick Actions + Schedule Preview */}
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 14, fontWeight: 600, color: "#C9874F", marginBottom: 14 }}>
              QUICK ACTIONS
            </div>
